...
@interface MyBlueToothManager ()<CBCentralManagerDelegate,CBPeripheralDelegate,CBPeripheralManagerDelegate>

@property (nonatomic, strong) CBCentralManager *centralManager;/**<中心管理器>*/
@property (nonatomic, strong) CBPeripheral *peripheral;/**<当前连接的外设>*/
@property (nonatomic, strong) NSArray<CBUUID *> *serviceUUIDs; /**< 要查找服务的UUIDs */

@property (nonatomic, strong) NSArray<CBUUID *> *characteristicUUIDs;/**<要查找特性的UUIDs >*/
...
@end
static MyBlueToothManager *instance = nil;
...
- (void)centralManager:(CBCentralManager *)central didConnectPeripheral:(CBPeripheral *)peripheral{
    ...
    if (_completionBlock) {
        _completionBlock(OptionStageConnection,peripheral,nil,nil,nil);
    }
...
- (void)centralManager:(CBCentralManager *)central didFailToConnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error{
    ...
    if (_completionBlock) {
        ...
        _completionBlock(OptionStageConnection,peripheral,nil,nil,error);
    }
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error{
    ...
    if (error) {
        ...
        if (_completionBlock) {
            ...
            _completionBlock(OptionStageSeekServices,peripheral,nil,nil,error);
        }
        return;
    }
    ...
    if (_completionBlock) {
        ...
        _completionBlock(OptionStageSeekServices,peripheral,nil,nil,nil);
    }
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverCharacteristicsForService:(CBService *)service error:(nullable NSError *)error
{
    if (error) {
        if (_completionBlock) {
            _completionBlock(OptionStageSeekCharacteristics,peripheral,service,nil,error);
        }
        return;
    }
    ...
    if (_completionBlock) {
        ...
        _completionBlock(OptionStageSeekCharacteristics,peripheral,service,nil,nil);
    }
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverDescriptorsForCharacteristic:(CBCharacteristic *)characteristic error:(nullable NSError *)error
{
    if (error) {
        if (_completionBlock) {
            _completionBlock(OptionStageSeekdescriptors,peripheral,nil,characteristic,error);
        }
        return;
    }
    
    if (_completionBlock) {
        _completionBlock(OptionStageSeekdescriptors,peripheral,nil,characteristic,nil);
    }
}
